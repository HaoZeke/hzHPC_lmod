...
local flexh   = pathJoin(home,".hpc",pkgName,version)

-- Paths
prepend_path("MANPATH",pathJoin(flexh,"share"))
prepend_path("LD_LIBRARY_PATH",pathJoin(flexh,"lib"))
prepend_path("PATH",pathJoin(flexh,"bin"))
