...
local sslhome   = pathJoin(home,".hpc",pkgName,version)

-- Paths
prepend_path("PATH",pathJoin(sslhome,"bin"))
prepend_path("MANPATH",pathJoin(sslhome,"share"))
prepend_path("INCLUDE",pathJoin(sslhome,"include"))
prepend_path("LD_LIBRARY_PATH",pathJoin(sslhome,"lib"))
prepend_path("PKG_CONFIG_PATH",pathJoin(sslhome,"lib","pkgconfig"))
